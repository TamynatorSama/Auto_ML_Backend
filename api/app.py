...
import db
from api import auth, config, jobs, keys, oauth, schemas, sources, tenancy, workspaces
...
def create_app(pool=None) -> FastAPI:
    ...
    # sources, schemas, jobs and keys hang their routes off tenancy.router at import, so this covers them too
